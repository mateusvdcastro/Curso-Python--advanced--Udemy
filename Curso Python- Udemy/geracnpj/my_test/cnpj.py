...
def eh_sequencia(cnpj):
    sequencia = cnpj[0] + len(cnpj)  # multiplicando uma string para ver se
    # o cnpj não é algo do tipo --> 555.555.555.55
...
def gera():
    ...
    inicio_cnpj = f'{primeiro_digito}{segundo_digito}' \
                  f'{segundo_bloco}{terceiro_bloco}{quarto_bloco}00'
