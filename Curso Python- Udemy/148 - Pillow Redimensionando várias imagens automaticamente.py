...
def main(main_images_folder, new_width=800):
    ...
    for root, dirs, files in os.walk(main_images_folder):
        for file in files:
            ...
            # if converted_tag in file_full_path:  # apaga as imagens convertidas
            ...
            if converted_tag in file_full_path:  # para não ficar varios "_CONVERTED" no nome das imagens
            ...
            # os.remove(file_full_path)   # remover os arquivos originais
