"""
1 - Python Orientado a Objetos - Crie uma função que exibe uma saudação com os parâmetros saudacao e nome.
"""
...
#
#
# soma(2, 1 - Python Orientado a Objetos, 3)
# soma(1 - Python Orientado a Objetos, 1 - Python Orientado a Objetos, 1 - Python Orientado a Objetos)
# soma(2, 1 - Python Orientado a Objetos, 1 - Python Orientado a Objetos)
